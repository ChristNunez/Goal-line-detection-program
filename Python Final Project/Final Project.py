...
# Declare previous circle color as red. Chnage if you wish German
previous_circle_color = (0, 0, 255) 

while True:
    # Read a frame from the video capture
	@@ -62,35 +74,30 @@ def detect_white_ball(frame):
    # Detect white ball
    ...
    if ball_position:
        ...
        # Take a screenshot of change in color and save as png
        if circle_color != previous_circle_color and circle_color == (0, 255, 0):
                    cv2.imwrite("Goal_Screenshot.png", frame)
                    print("Screenshot saved as Goal_Screenshot.png.")

        previous_circle_color = circle_color
        # draw circle
